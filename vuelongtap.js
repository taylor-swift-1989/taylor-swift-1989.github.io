...
import Vue from 'vue'
//var  minValue=binding.value&&binding.value.minValue||{};
//var  index=binding.value&&binding.value.index||0;
...
class VueTouch {
  ...
  constructor(el, binding, type) {
    ...
    let g = this;
//  var  minValue=binding.value&&binding.value.minValue||{};
//  var  index2=binding.value&&binding.value.index||0;
    g.obj = el;
    g.binding = binding;
    g.touchType = type;
...
export default Vue.directive("longtap", {
